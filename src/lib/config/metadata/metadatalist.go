...
var (
	...
	ConfigList = []Item{
		...
		{Name: common.OidcRedirectURL, Scope: SystemScope, Group: BasicGroup, EnvKey: "OIDC_REDIRECT_URL", DefaultValue: "https://host01.com", ItemType: &StringType{}, Editable: false},
